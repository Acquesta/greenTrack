...
function Inputs({ titulo, descricao, inputs, botao, outraPagina = ['' ,''], mudaValue, funcao}) {
    return ( 
        <div className="flex items-center h-screen">
            <div style={{backgroundImage: `URL(${imagem})`}} className="hidden xl:block h-screen w-[30vw] bg-center bg-cover"></div>
            <div className="absolute right-[30vw] top-[10vh] h-[20vw] w-[20vw] bg-gradient-to-b from-[#00611B] to-[#2B4A61] rounded-full"></div>
            <div className="absolute right-[20vw] bottom-[10vh] h-[10vw] w-[10vw] bg-gradient-to-b from-[#00611B] to-[#2B4A61] rounded-full"></div>
            <section className="z-10 w-2/3 xl:w-1/4 mx-auto pt-20 pb-10 px-10 backdrop-blur-lg border border-white rounded-lg shadow-xl">
