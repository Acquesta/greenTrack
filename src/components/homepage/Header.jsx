    ...
    return (
        <header className="flex fixed w-full bg-fundo items-center justify-between text-white px-6 sm:px-16 py-4 z-30">
            ...
            <div className="flex items-center">
                <div className="hidden lg:block align-center px-7 py-3 rounded-full leading-none hover:bg-white hover:text-verde hover:font-medium cursor-pointer">
                    <Link to='/Login' className="flex items-center gap-2"><Icon.UserCheck/>Login</Link>
                </div>
                <div className="hidden lg:block align-center px-7 py-3 rounded-full leading-none bg-azul hover:bg-white hover:text-azul hover:font-medium cursor-pointer ml-2">
                    <Link to='/Register'  className="flex items-center gap-2"><Icon.UserPlus/>Registre-se</Link>
                </div>
            </div>
