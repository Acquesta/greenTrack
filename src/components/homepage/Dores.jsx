    ...
    return (
        <div className="h-auto grid   items-center text-white gap-5" id="Dores">
            ...
            <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 mx-32 ">
                ...
                <div className="p-10 border-r border-b bg-gradient-to-br from-verdeescuro via-azul to-verdeescuro">
                    <h2 className="text-2xl mb-5 text-center">DADO 2</h2>
                    <p className="text-center">Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                </div>
                <div className="p-10 border-r border-b">
                    <h2 className="text-2xl mb-5 text-center">DADO 3</h2>
                    <p className="text-center">Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                </div>
                <div className="p-10 border-b">
                    <h2 className="text-2xl mb-5 text-center">DADO 4</h2>
                    <p className="text-center">Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                </div>
                <div className="p-10 border-t border-r">
                    <h2 className="text-2xl mb-5 text-center">DADO 5</h2>
                    <p className="text-center">Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                </div>
                <div className="p-10 border-t border-r">
                    <h2 className="text-2xl mb-5 text-center">DADO 6</h2>
                    <p className="text-center">Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                </div>
                <div className="p-10 border-t border-r">
                    <h2 className="text-2xl mb-5 text-center">DADO 7</h2>
                    <p className="text-center">Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                </div>
                <div className="p-10 border-t">
                    <h2 className="text-2xl mb-5 text-center">DADO 8</h2>
                    <p className="text-center">Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
                </div>
            </div>
