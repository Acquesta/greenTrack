function Dores() {
    return (
        <section className="h-auto relative pt-24 md:pt-26 items-center text-white gap-5" id="Dores">
            ...
            <section className="grid mx-16 my-10 text-xl grid-cols-1 lg:grid-cols-3 text-center gap-6">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 mx-7 lg:mx-32 ">
                <article className="p-10 sm:border-r border-b">
                ...
                <article className="p-10 md:border-r border-b bg-gradient-to-br from-verdeescuro via-azul to-verdeescuro">
                    ...
                    <div className="mt-2 underline hover:text-verdeescuro">
                        <a href="https://www.wri.org/insights/2023-ipcc-ar6-synthesis-report-climate-change-findings">World Resources Institute</a>
                    </div>
                </article>
                <article className="p-10 sm:border-r border-b">
                ...
                <article className="p-10 border-b">
                ...
                <article className="p-10 border-t sm:border-r">
                ...
                <article className="p-10 border-t xl:border-r">
                ...
                <article className="p-10 border-t">
                    <h2 className="text-3xl mb-5 font-bold">⬆️</h2>
                    <p className=" text-cinza">Sem uma transição para energias limpas, os custos associados a desastres climáticos, perdas agrícolas e saúde pública continuarão a aumentar​.</p>
                    <div className="mt-2 underline hover:text-azul">
                        <a href="https://www.wri.org/insights/2023-ipcc-ar6-synthesis-report-climate-change-findings">World Resources Institute</a>
                    </div>
                </article>
